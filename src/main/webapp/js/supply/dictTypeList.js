    ...
    $.dictTypeApp = {
        init : function(){
            ...
            var props = {
                ...
                dataUrl: $.ProjectURL()+"/config/dictTypeListJson.do",
                ...
                handlerCollections: [
                    {
                        ...
                        submitUrl: $.ProjectURL()+"/config/deleteDictType.do", //提交后台地址, 当 operateType=0时不能为空
                    ...
                    },
                    {
                        ...
                        redictUrl: $.ProjectURL()+"/config/dictTypeUpdatePage.do" //页面跳转地址, 当 operateType=1时不能为空
                    }
                ] //操作集合
            } ;
         ...
         */
        add:function(){
            window.location.href = $.ProjectURL()+"/config/dictTypeAddPage.do";
        },
        /***
         * 查询启用/停用列表
         */
